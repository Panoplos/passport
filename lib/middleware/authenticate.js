 ...
 *   - `redirect`         Client provided redirect method with signature of `(res: Object, url: String, status: ?Number): Any`
  ...
  return function authenticate(req, res, next) {
    ...
    (function attempt(i) {
      ...
      strategy.redirect = function redirect(url, status) {
        ...
        // Allow the client to supply it's own redirect method.
        if (options.redirect) {
          options.redirect(res, url, status)
          return
        }
